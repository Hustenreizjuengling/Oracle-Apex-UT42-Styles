// Baut Passer/docs/ARCHITECTURE.md aus der Vorlage und den aus den Quellen erzeugten Tabellen.
//   node Passer/tools/build-architecture.mjs   (Vorlage: Passer/docs/ARCHITECTURE.tpl.md)
import fs from 'node:fs';
import path from 'node:path';
import { execFileSync } from 'node:child_process';
import { ROOT } from '../../_tools/config.mjs';

const here = path.join(ROOT, 'Passer', 'tools');
const tpl = path.join(ROOT, 'Passer', 'docs', 'ARCHITECTURE.tpl.md');
...
const target = path.join(ROOT, 'Passer', 'docs', 'ARCHITECTURE.md');
