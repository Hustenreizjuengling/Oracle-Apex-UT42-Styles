// Baut Orbit/docs/ARCHITECTURE.md aus der Vorlage und den aus den Quellen erzeugten Tabellen.
//   node Orbit/tools/build-architecture.mjs   (Vorlage: Orbit/docs/ARCHITECTURE.tpl.md)
import fs from 'node:fs';
import path from 'node:path';
import { execFileSync } from 'node:child_process';
import { ROOT } from '../../_tools/config.mjs';

const here = path.join(ROOT, 'Orbit', 'tools');
const tpl = path.join(ROOT, 'Orbit', 'docs', 'ARCHITECTURE.tpl.md');
...
const target = path.join(ROOT, 'Orbit', 'docs', 'ARCHITECTURE.md');
