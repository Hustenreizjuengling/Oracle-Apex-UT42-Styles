// Erzeugt die Vorschaubilder für die README (Orbit/screenshots/).
//   node Orbit/tools/screenshots.mjs
...
const OUT = path.join(ROOT, 'Orbit', 'screenshots');
...
async function run(style, { mobile = false } = {}) {
  const lab = await launchLab({ theme: 'Orbit', style, app: 9042, mobile, width: mobile ? 390 : 1440, height: mobile ? 844 : 900 });
  try {
