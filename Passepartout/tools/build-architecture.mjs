// Baut Passepartout/docs/ARCHITECTURE.md aus der Vorlage und den aus den Quellen erzeugten Tabellen.
//   node Passepartout/tools/build-architecture.mjs   (Vorlage: Passepartout/docs/ARCHITECTURE.tpl.md)
import fs from 'node:fs';
import path from 'node:path';
import { execFileSync } from 'node:child_process';
import { ROOT } from '../../_tools/config.mjs';

const here = path.join(ROOT, 'Passepartout', 'tools');
const tpl = path.join(ROOT, 'Passepartout', 'docs', 'ARCHITECTURE.tpl.md');
...
const target = path.join(ROOT, 'Passepartout', 'docs', 'ARCHITECTURE.md');
