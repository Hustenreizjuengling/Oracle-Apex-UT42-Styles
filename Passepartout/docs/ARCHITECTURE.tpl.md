...
> Token-Tabellen und Kontrastwerte sind aus den Quellen erzeugt (`node Passepartout/tools/build-architecture.mjs` aus `docs/ARCHITECTURE.tpl.md`), Stand: {{DATE}}. Änderungen am Text nur in der Vorlage.
