// Baut Kracherl/docs/ARCHITECTURE.md aus der Vorlage und den aus den Quellen erzeugten Tabellen.
//   node Kracherl/tools/build-architecture.mjs   (Vorlage: Kracherl/docs/ARCHITECTURE.tpl.md)
import fs from 'node:fs';
import path from 'node:path';
import { execFileSync } from 'node:child_process';
import { ROOT } from '../../_tools/config.mjs';

const here = path.join(ROOT, 'Kracherl', 'tools');
const tpl = path.join(ROOT, 'Kracherl', 'docs', 'ARCHITECTURE.tpl.md');
...
const target = path.join(ROOT, 'Kracherl', 'docs', 'ARCHITECTURE.md');
